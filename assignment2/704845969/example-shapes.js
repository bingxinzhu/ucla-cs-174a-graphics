...
Declare_Any_Class( "Triangle",    // First, the simplest possible Shape – one triangle.  It has 3 vertices, each having their own 3D position, normal
  ...
  // *********** TRIANGLE ***********
Declare_Any_Class( "mypoly",    // First, the simplest possible Shape – one triangle.  It has 3 vertices, each having their own 3D position, normal
  { 'populate'()                  // vector, and texture-space coordinate.
      { this.positions      = [ 
                                vec3(0,0,0), vec3(1,0.5,0),vec3(0.5,1,0),
                                vec3(0,0,0), vec3(0.5,1,0),vec3(0.3,0.3,0.3),
                                vec3(0,0,0), vec3(1,0.5,0),vec3(0.3,0.3,0.3),
                         //       vec3(0.5,1,0),vec3(0.3,0.3,0.3),vec3(1,0.5,0),


                                vec3(0,0,0), vec3(-0.5,1,0),vec3(-1,0.5,0),
                                vec3(0,0,0), vec3(-0.5,1,0),vec3(-0.3,0.3,0.3),
                                vec3(0,0,0), vec3(-1,0.5,0),vec3(-0.3,0.3,0.3),
                         //       vec3(-1,0.5,0),vec3(-0.3,0.3,0.3),vec3(-0.5,1,0),
        ...
        this.normals        = [ 
                                ...
                                vec3(0.5,0,0.5), vec3(0.5,0,0.5),vec3(0.5,0,0.5),
                                vec3(-0.5,0,-0.5), vec3(-0.5,0,-0.5),vec3(-0.5,0,-0.5),

                                vec3(1,0,0), vec3(1,0,0),vec3(1,0,0),
                                vec3(0,0.5,0.5), vec3(0,0.5,0.5),vec3(0,0.5,0.5),
                                vec3(0,-0.5,-0.5), vec3(0,-0.5,-0.5),vec3(0,-0.5,-0.5),
        ...
        this.texture_coords = [
                            ...
                            //    vec2(.2,0),vec2(0,1),vec2(.4,1),  
                            //    vec2(.4,1),vec2(.2,0),vec2(.6,0),
                            //    vec2(.2,0),vec2(0,1),vec2(.4,1),  
...
Declare_Any_Class( "mypoly1",
{ 'populate'()                  
    {

                  this.positions.push(vec3(1,2,1), vec3(0,0,0), vec3(2,0,0),  
                                      vec3(1,2,1), vec3(0,0,0), vec3(0,0,2),  
                                      vec3(1,2,1), vec3(0,0,2), vec3(2,0,2),  
                                      vec3(1,2,1), vec3(2,0,2), vec3(2,0,0),  
                                      vec3(0,0,0), vec3(0,0,2), vec3(2,0,0),  
                                      vec3(2,0,0), vec3(2,0,2), vec3(0,0,2)); 
                              
                                        
                  this.normals.push(vec3(0,-2,4),vec3(0,-2,4),vec3(0,-2,4), 
                                    vec3(-4,2,0),vec3(-4,2,0),vec3(-4,2,0), 
                                    vec3(0,2,4),vec3(0,2,4),vec3(0,2,4), 
                                    vec3(4,2,-8),vec3(4,2,-8),vec3(4,2,-8), 
